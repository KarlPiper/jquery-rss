//modified from https://github.com/sdepold/jquery-rss
(function (d) {
	var e = function (a, b, c, f) {
		...
		this.options = d.extend({
				...
				tokens: {
					published: function (entry, tokens) {
				...
				offsetEnd: !1,
				error: function () {
					console.log("jQuery-RSS: URL doesn't link to valid RSS-Feed");
				},
				onData: function () {},
				success: function () {},
			},
